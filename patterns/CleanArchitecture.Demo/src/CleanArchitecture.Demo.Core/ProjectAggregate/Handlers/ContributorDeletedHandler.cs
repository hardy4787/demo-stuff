using CleanArchitecture.Demo.Core.ContributorAggregate.Events;
using CleanArchitecture.Demo.Core.ProjectAggregate.Specifications;
using CleanArchitecture.Demo.SharedKernel.Interfaces;
using MediatR;

namespace CleanArchitecture.Demo.Core.ProjectAggregate.Handlers;
